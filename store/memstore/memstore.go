// Package memstore offers an in-memory store implementation for miser.
package memstore // import "github.com/pantianying/miser/store/memstore"
...
// MemStore is an in-memory store implementation for miser. It
