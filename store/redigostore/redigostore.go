// Package redigostore offers Redis-based store implementation for miser using redigo.
package redigostore // import "github.com/pantianying/miser/store/redigostore"
