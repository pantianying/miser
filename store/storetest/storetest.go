// Package storetest provides a helper for testing miser stores.
package storetest // import "github.com/pantianying/miser/store/storetest"
...
// compliance with the miser API. It does not require support
// for TTLs.
func TestGCRAStore(t *testing.T, st miser.GCRAStore) {
...
func TestGCRAStoreTTL(t *testing.T, st miser.GCRAStore) {
	ttl := time.Second
	want := int64(1)
	key := "ttl"
...
func BenchmarkGCRAStore(b *testing.B, st miser.GCRAStore) {
	seed := int64(42)
